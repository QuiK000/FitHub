...
const MainLayout = () => {
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-50">
      {/* Sidebar */}
      <aside className="hidden w-64 flex-col border-r border-slate-800/80 bg-slate-950/70 px-4 py-6 backdrop-blur-xl md:flex">
        <div className="mb-8 flex items-center gap-3 px-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-400 via-cyan-400 to-sky-500 shadow-soft-glow">
        ...
        <div className="mt-auto space-y-4 border-t border-slate-800/80 pt-4">
          ...
          <button className="flex w-full items-center justify-between rounded-xl border border-slate-800/80 bg-slate-900/80 px-3 py-2 text-xs font-medium text-slate-400 transition hover:border-red-500/60 hover:bg-red-500/5 hover:text-red-300">
        ...
        <header className="sticky top-0 z-20 border-b border-slate-800/80 bg-slate-950/70 backdrop-blur-xl">
          <div className="flex items-center justify-between px-4 py-3 md:px-8">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/90 md:hidden">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden items-center gap-2 rounded-full border border-slate-800/80 bg-slate-900/80 px-3 py-1.5 text-xs text-slate-400 md:flex">
              ...
              <button className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-800/80 bg-slate-900/90 text-slate-400 transition hover:border-slate-700 hover:text-slate-100">
                <Settings className="h-4 w-4" />
              </button>

              <div className="flex items-center gap-2 rounded-full border border-slate-800/80 bg-slate-900/90 px-2 py-1">
                <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-slate-700 via-slate-500 to-slate-300" />
