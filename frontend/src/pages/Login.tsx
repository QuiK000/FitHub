...
const Login = () => {
  ...
  if (isAuthenticated || token) {
    // Already signed in, keep them on the dashboard
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-8 text-slate-50">
      ...
      >
        ...
        {/* Login form */}
        <div className="flex flex-col justify-center rounded-2xl border border-slate-800/80 bg-slate-950/80 p-5 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5 text-sm">
              ...
              <div className="flex items-center gap-2 rounded-xl border border-slate-800/80 bg-slate-900/80 px-3 py-2.5 text-sm text-slate-100 focus-within:border-emerald-500/80 focus-within:bg-slate-900 focus-within:ring-1 focus-within:ring-emerald-500/70">
